...
$result = mysqli_query($conn, "SELECT * FROM fifa.f3");
...
<head>
  ...
  <script type="text/javascript">
    ...
    function drawBackgroundColor() {
      ...
      var options = {
        title: '남해안 도루묵 어획량 추이 (1970 ~ 2050)',
        titleTextStyle: {
          fontSize: 20,
          bold: true
        },
      ...
      <div class="box_A_01">
        <div class="box_B">
          ...
          <p style="font-size:20px; text-align:center; margin: 30px 50px"> <b>2020 </b>년 <br>
            ...
            $conn = mysqli_connect("localhost", "root", "123456");
            mysqli_select_db($conn, "fifa");
            $resultt = mysqli_query($conn, "SELECT * FROM fifa.f3");
            ...
            while ($rowss = mysqli_fetch_assoc($resultt)) {
              ...
              if ($splitedyear[0] == $todayyear + 1) {
                ...
                $rate = (($rowss['fishing'] - $presentfishing) / 1) * 100;
                if ($rate < 0) {
