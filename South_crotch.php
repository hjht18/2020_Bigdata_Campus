...
$result = mysqli_query($conn, "SELECT * FROM fifa.f2");
...
<head>
  ...
  <link rel="stylesheet" href="Horizontal_menu.css?after" />
...
<body background="images/background.jpg">
      ...
      <div class="box_A_01">
        <div class="box_B">
          ...
          <p style="font-size:20px; text-align:center; margin: 30px 50px"> <b>2020 </b>년 <br>
            ...
            $conn = mysqli_connect("localhost", "root", "123456");
            mysqli_select_db($conn, "fifa");
            $resultt = mysqli_query($conn, "SELECT * FROM fifa.f2");
  ...
  <script>
    ...
    var polygonPath = [
      new kakao.maps.LatLng(35.446888, 129.417286),
      new kakao.maps.LatLng(35.106068, 129.148121),
      new kakao.maps.LatLng(34.989143, 128.851490),
      new kakao.maps.LatLng(34.687066, 128.587818),
      new kakao.maps.LatLng(34.899087, 128.087490),
      new kakao.maps.LatLng(34.605966, 127.646709),
      new kakao.maps.LatLng(34.423474, 127.486605),
      new kakao.maps.LatLng(34.128006, 126.547331),
      new kakao.maps.LatLng(34.394855, 126.077694),
      new kakao.maps.LatLng(35.449392, 126.403238),
      new kakao.maps.LatLng(34.660856, 125.407928),
      new kakao.maps.LatLng(34.068346, 125.117073),
      new kakao.maps.LatLng(33.137142, 125.306529),
      new kakao.maps.LatLng(32.698106, 125.690777),
      new kakao.maps.LatLng(33.016401, 127.139714),
      new kakao.maps.LatLng(33.740574, 127.737434),
      new kakao.maps.LatLng(34.383845, 128.468573),
    ];
